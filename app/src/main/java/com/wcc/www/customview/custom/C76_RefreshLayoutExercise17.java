...
public class C76_RefreshLayoutExercise17 extends ViewGroup {
    ...
    private AnimationDrawable loadmore_anim;

    public C76_RefreshLayoutExercise17(Context context, AttributeSet attrs) {
        super(context, attrs);
        mScroller = new Scroller(context);
        distanceOverToLoad = dp2px(50);
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.C42_RefreshLayout3);
        mBackground = typedArray.getDrawable(R.styleable.C42_RefreshLayout3_smart_ui_background);
        mEnablePullDown = typedArray.getBoolean(R.styleable.C42_RefreshLayout3_smart_ui_enable_pull_down, true);
        mEnablePullUp = typedArray.getBoolean(R.styleable.C42_RefreshLayout3_smart_ui_enable_pull_up, true);
        typedArray.recycle();
    }
    ...
    private void onStopScroll()
    {
        ...
        if(Math.abs(scrollY) >= distanceOverToLoad)
        {
            ...
            {
                mScroller.startScroll(0, scrollY, 0, -scrollY -distanceOverToLoad);
        ...
        switch (state)
        {
            ...
            case State.SUCCESS:
                if(currentState == State.DOWN_RELEASE)
                {
                    ...
                    tv_refresh_hint.setText("refersh succeed");
    ...
    protected void onFinishInflate() {
        ...
        if (mEnablePullDown) {
            refreshView = layoutInflater.inflate(R.layout.layout_refresh_header, null);
            ...
            refresh_anim = (AnimationDrawable) iv_refresh_loading.getBackground();
            if (mBackground != null)
        ...
        if (mEnablePullUp)
        {
            loadmoreView = layoutInflater.inflate(R.layout.layout_refresh_footer, null);
            ...
            loadmore_anim = (AnimationDrawable) iv_loadmore_loading.getBackground();
            if(mBackground != null)
