...
public class C47_RefreshLayoutExercise4 extends ViewGroup {
    ...
    public C47_RefreshLayoutExercise4(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void updateState(int state)
    {
        switch (state)
        {
            ...
            case State.DONE:
                ...
                {
                    iv_header_loading.setVisibility(GONE);
                    tv_header_hint.setText("刷新成功");
                }else if(currentState == State.UP_RELEASE)
                {
                    iv_footer_loading.setVisibility(GONE);
    ...
    private void rotateArrow(View iv)
    {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for(int i = 0; i < childCount; i ++)
        {
            ...
            if(child == header)
                ...
                child.layout(0, mTarget.getMeasuredHeight(), child.getMeasuredWidth(),
                        mTarget.getMeasuredHeight() + child.getMeasuredHeight());
            else
    ...
    protected void onFinishInflate() {
        ...
        if(mEnablePullDown)
        {
            header = layoutInflate.inflate(R.layout.layout_refresh_header, null);
        ...
        if(mEnablePullUp)
        {
            footer = layoutInflate.inflate(R.layout.layout_refresh_footer, null);
