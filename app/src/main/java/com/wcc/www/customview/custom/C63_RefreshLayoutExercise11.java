...
public class C63_RefreshLayoutExercise11 extends ViewGroup {
    ...
    public C63_RefreshLayoutExercise11(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for(int i = 0; i < childCount; i ++)
        {
            ...
            if(child == refreshView)
                ...
                child.layout(0, 0, mTarget.getMeasuredWidth(), mTarget.getMeasuredHeight());
        }
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int childCount = getChildCount();
        for(int i = 0; i < childCount; i ++)
            getChildAt(i).measure(MeasureSpec.makeMeasureSpec(getMeasuredWidth() - getPaddingLeft() - getPaddingRight(), MeasureSpec.EXACTLY),
