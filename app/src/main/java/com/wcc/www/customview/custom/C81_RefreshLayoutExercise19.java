...
/**
 * Created by 王晨晨 on 2017/10/30.
 */

public class C81_RefreshLayoutExercise19 extends ViewGroup {
    ...
    public C81_RefreshLayoutExercise19(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        switch (state)
        {
            ...
            case State.FAILURE:
                ...
                }else if(currentState == State.UP_RELEASE)
                {
                    ...
                    tv_loadmore_hint.setText("loadmore failed");
                }
                break;
        }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for(int i = 0; i < childCount; i ++)
        {
            ...
            if(child == refreshView)
                ...
                child.layout(0, mTarget.getMeasuredHeight(), child.getMeasuredWidth(), child.getMeasuredHeight() + mTarget.getMeasuredHeight());
            else
