...
public class C60_2RefreshLayoutExercise5 extends RelativeLayout implements View.OnTouchListener {
    ...
    public C60_2RefreshLayoutExercise5(Context context, AttributeSet attrs) {
        super(context, attrs);
        mTimer = new Timer();
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction())
        {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                requestLayout();
                if(currentState == PULL_TO_REFRESH && moveDeltaY >= distanceOverToRefresh)
                    changeState(RELEASE_TO_REFRESH);
                if(currentState == RELEASE_TO_REFRESH && moveDeltaY <= distanceOverToRefresh)
