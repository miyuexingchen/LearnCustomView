...
public class C66_RefreshLayoutExercise13 extends ViewGroup {
    ...
    public C66_RefreshLayoutExercise13(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for(int i = 0; i < childCount; i ++)
        {
            ...
            if(child == refreshView)
                ...
                child.layout(0, mTarget.getMeasuredHeight(), child.getMeasuredWidth(), mTarget.getMeasuredHeight() + child.getMeasuredWidth());
            else 
