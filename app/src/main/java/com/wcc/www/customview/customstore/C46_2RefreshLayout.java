...
public class C46_2RefreshLayout extends RelativeLayout implements OnTouchListener{
    ...
    Handler updateHandler = new Handler()
    {
        ...
        public void handleMessage(Message msg)
        {
            ...
            if (state == REFRESHING && moveDeltaY <= refreshDist && !whenRefreshingDetermineToHideHead)
            {
    ...
    public C46_2RefreshLayout(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        initView(context);
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent ev)
    {
        ...
        switch (ev.getActionMasked())
        {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                {
                    // 对实际滑动距离做缩小，造成用力拉的感觉
                    moveDeltaY = moveDeltaY + (y - lastY) / radio;
                    if (moveDeltaY < 0)
                        moveDeltaY = 0;
