...
public class C75_2RefreshLayoutExercise9 extends RelativeLayout {
    ...
    public C75_2RefreshLayoutExercise9(Context context, AttributeSet attrs) {
        super(context, attrs);
        mTimer = new Timer();
    ...
    private float ratio = 3, moveSpeed = 8, moveDeltaY;
