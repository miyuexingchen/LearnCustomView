...
public class C68_Strengthen2RefreshLayoutExercise3 extends RelativeLayout {
    ...
    public C68_Strengthen2RefreshLayoutExercise3(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        refreshView.layout(0, (int) (pullDownY + pullUpY) - refreshView.getMeasuredHeight(), refreshView.getMeasuredWidth(), (int) (pullUpY + pullDownY));
        contentView.layout(0, (int) (pullDownY + pullUpY), contentView.getMeasuredWidth(), (int) (pullUpY + pullDownY) + contentView.getMeasuredHeight());
        loadmoreView.layout(0, (int) (pullDownY + pullUpY) + contentView.getMeasuredHeight(), loadmoreView.getMeasuredWidth(), (int) (pullUpY + pullDownY) + contentView.getMeasuredHeight() + loadmoreView.getMeasuredHeight());
    }
